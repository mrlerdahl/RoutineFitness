...
//{
//    public class FakeLiftRepository : IRoutineFitnessRepositor
//    {
//        public IQueryable<Lift> Lifts => new List<Lift>
//        {
//            new Lift { LiftId = 1, Category = "Legs", LiftName = "Squats", LiftDescription = "This is just a test description", VideoUrl = "url to display video", ImageUrl="~/wwwroot/images/legs.png"},
